...
var _$body = (0, _jquery2['default'])('html, body');
...
var Smoothscroll = (function () {
  ...
  _createClass(Smoothscroll, [{
    ...
    value: function _configure(el, opts) {
      ...
      this.opts = _jquery2['default'].extend({}, _defaults, opts);
      if (this.$el.attr('href') !== '#') {
        this.$target = (0, _jquery2['default'])(this.$el.attr('href'));
      }
    }
  }, {
    key: '_handleClick',
    ...
    value: function addEasing(name, func) {
      _jquery2['default'].easing[name] = func;
    }
  }, {
    key: 'canselScroll',
